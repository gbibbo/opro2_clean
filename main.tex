...
Table~\ref{tab:prelim_multimodel_comparison} provides a preliminary snapshot comparing Qwen2-Audio and the frozen Qwen3-Omni model. The Qwen3-Omni OPRO result (91.1\% BA) comes from the full 21,340-sample test set; the frozen Qwen3-Omni model achieves performance comparable to the LoRA-adapted Qwen2-Audio without any parameter updates, suggesting that architectural or scale differences may confer robustness gains that Qwen2-Audio requires fine-tuning to achieve. The detailed per-class recalls, paired tests, and per-axis psychometric analyses reported below focus on the core Qwen2-Audio configurations.
